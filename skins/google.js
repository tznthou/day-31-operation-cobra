...
export const title = '2025 AI 趨勢 - Google 搜尋';
...
<header class="google-header">
  <div class="header-top">
    ...
    <div class="search-box">
      ...
      <input type="text" class="search-input" value="2025 AI 趨勢" readonly>
    </div>
  </div>
  <nav class="nav-tabs">
    <div class="nav-tab active">全部</div>
    <div class="nav-tab">新聞</div>
    <div class="nav-tab">圖片</div>
    <div class="nav-tab">影片</div>
    <div class="nav-tab">更多</div>
  </nav>
</header>
<main class="search-results">
  <div class="result-stats">約有 1,240,000,000 項結果 (搜尋時間：0.42 秒)</div>
