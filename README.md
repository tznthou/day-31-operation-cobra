...
一款專為上班族設計的「隱形」小遊戲。外觀是工作介面，內裏是經典貪食蛇。按 Esc 可瞬間暫停並隱藏遊戲，完美應對老闆突襲。
...
六套偽裝皮膚，六種不同的「正在工作」假象：Google 搜尋、Excel 報表、Jira 看板、Slack 聊天、Notion 文件、VS Code 編輯器。右下角的小 widget 裡藏著貪食蛇遊戲，按 Esc 立即變成時鐘——老闆來了也不怕。
